                        ...
                        <div class="preview">
                            ...
                            <div class="form-inlin mt-5 standard-type">
                                ...
                                <div class="grid grid-cols-12 gap-2">
                                    <input type="text" class="form-control col-span-4" placeholder="P" name="length"
                                        id="length">
                                    <input type="text" class="form-control col-span-4" placeholder="L" name="width"
                                        id="width">
                                    <input type="text" class="form-control col-span-4" placeholder="T" name="height"
                                        id="height">
                                </div>
                            </div>
                            <div class="form-inlin mt-5 standard-type">
                            ...
                            <div class="form-inlin mt-5 top-bottom">
                                ...
                                <div class="grid grid-cols-12 gap-2">
                                    <input type="text" class="form-control col-span-4" placeholder="P" name="top_length"
                                        id="top_length">
                                    <input type="text" class="form-control col-span-4" placeholder="L" name="top_width"
                                        id="top_width">
                                    <input type="text" class="form-control col-span-4" placeholder="T" name="top_height"
                                        id="top_height">
                                </div>
                            </div>
                            <div class="form-inlin mt-5 top-bottom">

        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr />
                    <form method="POST" action="{{route('supplier.save')}}" id="collapse-form">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->pic}}</td>
                                    <td>{{$data->tax_type}}</td>
                                    <td class="text-center"><a href="{{route('supplier.edit', ['id' => $data->id])}}"><i class="mdi mdi-settings menu-icon"
                                                style="font-size: 24px;"></i></a><a href="{{route('supplier.delete', ['id' => $data->id])}}"><i class="mdi mdi-delete"

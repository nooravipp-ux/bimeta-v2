    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sales-order" aria-expanded="false" aria-controls="sales-order-menu">
                    ...
                    <div class="collapse" id="sales-order">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/buttons.html">PO Customer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/dropdowns.html">Tracking Order</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/typography.html">Index Price</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="production">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/buttons.html">SPK</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/dropdowns.html">Perencanaan Produksi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/typography.html">Progress Produksi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/typography.html">Pemakaian Material</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="stok">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/buttons.html">Delivery</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="master-data">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/buttons.html">Supplier</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/dropdowns.html">Customer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/typography.html">Material</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="pages/ui-features/typography.html">Substances</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <div class="col-xl-8 stretch-card grid-margin">
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table custom-table text-dark">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../assets/images/faces/face5.jpg" class="me-2"
                                                            alt="image" /> Ina Curry
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../assets/images/faces/face7.jpg" class="me-2"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="../assets/images/faces/face9.jpg" class="me-2"
                                    ...
                                    <a class="text-black font-13 d-block pt-2 pb-2 pb-lg-0 font-weight-bold ps-4"
                                        href="#">Show more</a>
                                </div>
                            </div>
                        </div>

                    ...
                    <table class="table table-striped">
                        <thead class="bg-success">
                            <tr>
                                ...
                                <th class="whitespace-nowrap text-center">JUMLAH (ROLL)</th>
                                            ...
                                            <div class="preview">
                                                <div class="form-inline mt-5">
                                                    ...
                                                    <select data-placeholder="Pilih Material" class="tom-select w-full form-control" name="material_id" required>
                                                        ...
                                                        <option value="{{$material->id}}">{{$material->paper_type}} {{$material->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-inline mt-5">
                                                ...
                                                <div class="form-inline mt-5">
                                                    <label for="vertical-form-1" class="form-label sm:w-20">Berat (Kg)</label>
                                                    <input id="vertical-form-1" type="number" class="form-control" name="weight" required>
                                                </div>
                                                <div class="form-inline mt-5">
                                                    <label for="vertical-form-1" class="form-label sm:w-20">Jumlah (Roll)</label>

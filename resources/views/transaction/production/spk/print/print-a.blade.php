...
<body>
    <div class="container" style="border: 1px solid black;">
        ...
        <div class="row">
            <div class="col col-6 text-center" style="height: 30px; padding-top: 10px;"></div>
            <div class="col col-6 text-center" style="border: 1px solid black; height: 30px; padding-top: 10px;">
                <span>CETAKAN</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-6 text-center" style="height: 30px; padding-top: 10px;"></div>
            <div class="col col-6 text-center" style="border: 1px solid black; height: 40px; padding-top: 10px;">
                <span>PRINT</span>
            </div>
        </div>
